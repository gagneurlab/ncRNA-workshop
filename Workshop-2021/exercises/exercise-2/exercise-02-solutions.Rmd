...
```{r}
## Here you should provide the path to data on YOUR computer
gtex.annotation <- fread("~/R_workshop/ncRNA-workshop/Workshop-2021/extdata/gtex-dummy-dataset.csv")
...
```{r}
## Here you should provide the path to data on YOUR computer
messy_file <- "~/R_workshop/ncRNA-workshop/Workshop-2021/extdata/example_product_data.csv"
...
```{r}
## Here you should provide the path to data on YOUR computer
messy_dt <- fread("~/R_workshop/ncRNA-workshop/Workshop-2021/extdata/weather.txt")
head(messy_dt)
dim(messy_dt)
```
...
```{r}
# An alternative tidy code version (using the pipe operator)
tidy_dt <- messy_dt %>% 
