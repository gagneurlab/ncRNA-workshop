...
knitr::opts_chunk$set(
  ...
  echo=T, warning=FALSE, message=FALSE, eval=T,
  results="show", fig.show="hide"
)
...
iris2[, identical(sd_mine, sd)]  # Or identical(iris2$sd_mine, iris2$sd)
```
...
```{r}
# Using merge
poke_merge <- merge(poke_dt, evolution_dt[,.(Name, Evolution, Level)], by="Name")  # Only pokemon with evolutions
