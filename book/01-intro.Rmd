...
![Rstudio](../assets/img/Rstudio-1.png)
...
1. From the menu bar we click File > New Project
   \newline
   ![New Project 1](../assets/img/Rstudio-3.png)
2. Then we choose New Directory > New Project
   \newline
   ![New Project 2](../assets/img/Rstudio-4.png)
   \newline
   ![New Project 3](../assets/img/Rstudio-5.png)

3. Give a name to your New Project eg. dataviz-demo, and set the path where the new project will be created
   \newline
   ![New Project 4](../assets/img/Rstudio-7.png)
4. The new project will be loaded and you can see the name of your project on the top bar
   \newline
   ![New Project 5](../assets/img/Rstudio-8.png)
5. Now you can start typing command on the console
   \newline
   ![New Project 6](../assets/img/Rstudio-9.png)
6. By assigning a variable, the variable and its value will appear on the environment panel
   \newline
   ![New Project 7](../assets/img/Rstudio-10.png)
   \newline
   ![New Project 8](../assets/img/Rstudio-12.png)
   \newline
   ![New Project 9](../assets/img/Rstudio-13.png)

7. By calling `?toupper` the toupper function will appear on the help panel
  \newline
   ![New Project 10](../assets/img/Rstudio-15.png)
8. Typing endlessly commands in the console can cumbersome, so in order for us to be able to reproduce our code, what we do is that we write our commands in a script file. To make a new script file we can either click `File > New File > R` script or click or the `+` icon (below the File menu) and then click `R script` or simply press `Ctrl+Shift+N`
  \newline
   ![New Project 11](../assets/img/Rstudio-16.png)
   \newline
   ![New Project 12](../assets/img/Rstudio-17.png)
\pagebreak
