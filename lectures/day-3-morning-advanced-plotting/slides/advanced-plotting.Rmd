...
```{r lec07_ggpairs, fig.width=4, fig.height=4, eval=FALSE}
library(GGally)
...
```{r lec07_ggpairs2, fig.width=4, fig.height=4, echo=FALSE}
library(GGally)
ggpairs(mpg, columns = c("displ","cyl","cty","hwy"),
        upper = list(continuous = wrap("cor", method = "spearman"))) + mytheme
```
...
```{r lec07_heatmap,  fig.height=3, fig.width=4, out.width="580px", eval=FALSE}
